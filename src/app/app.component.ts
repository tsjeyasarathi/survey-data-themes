...
export class AppComponent {
  ...
  data = {
    ...
    'Placing Orders Feedback': {
      'sub-categories': ['App/Mobile order', 'Alternate/New Products', 'Discontinued Products',
        'Existing Products', 'Substituted Products', 'Offline Ordering', 'Online Orders', 'Replacement',
        'Stock Issues'],
  ...
  selected_category = 'Marketing Associate';
